        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-muted font-sans font-medium leading-relaxed mb-6">
              In Today&apos;ss fast-paced world, speed is everything. CollabDocs eliminates the friction of traditional document editing, allowing you to focus on what matters most: your content.
            </p>
